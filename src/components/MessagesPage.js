    ...
    try {
      ...
      if (user.isSupplier) {
        ...
        if (selectedPair?.supplierEmail || selectedPair?.supplierName) {
          ...
          // - supplier_email matches (all messages for this supplier)
          // - sender matches (messages from supplier to admin)
          // - receiver matches supplier email (messages from admin to supplier)
          // - receiver matches adminId (messages from supplier to admin)
      ...
      console.log('🔍 Fetched messages query result:', {
